...
const TimelineContainer = () => {
  ...
  const { handleTaskUpdate, handleMarkTaskAsDone } = useTasksActions();
    ...
    <Row>
      <ContentBox>
        ...
        {groupedTasks.map((group) => (
          <TimelineSection key={group.date} group={group} selectTask={selectTask} selectedTask={selectedTask} />
        ))}
      </ContentBox>

      <SelectedTaskSection task={selectedTask} onTaskUpdate={onTaskUpdate} deselectTask={deselectTask} markAsDone={handleMarkTaskAsDone} />
    </Row>
  );
};
